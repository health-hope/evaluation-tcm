    ...
    <div class="survey">
        ...
        <template v-for="(sd,i) in surveyData">
            ...
            >
                ...
                <questions-style :text="sd.questionContent" :code="evaluationCode" :loading="sd.loading"></questions-style>
                <!-- 进场动画 -->
    ...
    export default {
        ...
        methods: {
            ...
            async getTopic(a, b, c, d, e) {
                ...
                let data = await apiSurveyData(this.evaluationCode, this.userInfo)
            ...
            async ok() {
                ...
                const res = await apiSaveSurveyData(this.quesBankId, this.evaluationCode, this.userInfo, userOptions)
                ...
                $(clas1).stop().animate({ marginRight: '2.9rem', marginLeft: `${eleLeft}rem`, height: `${ele.height}px` }, 300, () => {
                    ...
                    this.surveyData[i].options.forEach(item => {
                        if (item.check || this.surveyData[i].questionType > 2) {
                            ...
                            if(item.nextQuesCode){
                                tiaoTi=item.nextQuesCode
                            }
                        }
                    })
                    // 判断之前有没有做过这道题
